    ...
    if not day_files:
        ...
        if month_csv.empty:
            ...
            if not equipment_row.empty:
                ...
                # WARNING: Buddy do not swap these two around because it fucked my whole life 
                ...
                # ---- Outlier detection using the UCL/LCL from equipment row ----
                ...
                # ---- Split data into inside/outside using the computed Outlier flag ----
                ...
                # Red stars for points OUTSIDE (only if any)
